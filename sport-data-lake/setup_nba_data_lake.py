...
bucket_name = "sports-analytics-data-lake-10263"  # Change to a unique S3 bucket name
...
# Debugging: Print values (remove this after testing)
print(f"API Key: {api_key}")  # Should print your actual API key
print(f"NBA Endpoint: {nba_endpoint}")  # Should print the URL

# Check if values are missing
if not api_key or not nba_endpoint:
    print("Error: Missing API key or NBA endpoint. Check your .env file.")
